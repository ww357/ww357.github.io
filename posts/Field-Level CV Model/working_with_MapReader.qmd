...
After this was done, I broadcasted the resulting predictions onto the polygon features to visualise the results in ArcGIS Pro,

, loaded them into the MapReader annotation interface and model,

with the use of computer vision to read historic OS maps.

MOVE TO PAPER: This model is not so much identifying the exact dimentions of hedgerow loss but instead documenting the vague locality of the spatial and temporal dilution of agricultural spaces across England. Being segmented by only certain fields in the Crop Plus dataset, large portions of exinct or extant hedgerow network lay or currently lies.
